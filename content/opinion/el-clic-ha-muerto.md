...
author: "Roger Calvo"
tldr: "El clic ha muerto como métrica de vanidad; la nueva moneda es la citación. Para sobrevivir en la era de los 'Answer Engines', debes optimizar para Ganancia de Información (algo que la IA no sepa) y convertirte en una 'Grounding Source' verificable."
---

![El Clic Ha Muerto - GEO](/images/posts/el-clic-ha-muerto/cover.jpg)
...
1.  **Estructura Citable:** Usa formatos que los LLMs extraen fácilmente: tablas comparativas, listas con viñetas, definiciones claras tras un encabezado H2 ("Qué es X").
2.  **Schema Markup Robusto:** No solo lo básico. Usa `FAQPage`, `Article`, `TechArticle` y `Organization` para "alimentar" al Grafo de Conocimiento.
...
*   **Tráfico Referido por IA:** Segmenta en Analytics el tráfico proveniente de `openai.com`, `bing.com` (chat) y `perplexity.ai`.
...
No alimentes al algoritmo con contenido vainilla.
**Lidéralo con opinión, datos y estructura.**
