...
export default function Booking() {
    return (
        <>
            <SeoHead noindex title="Contrataciones | Calvo Creativo" description="Plazas limitadas para consultoría SEO estratégica. Agenda una sesión de diagnóstico y define si somos el fit correcto antes de comprometerte." />
            <Navigation />
