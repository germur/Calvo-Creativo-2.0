...
export default function EstrategiaContenidos() {
    return (
        <ServiceLayout
            title="Estrategia de Contenidos y Autoridad Temática | Calvo Creativo"
        ...
        >
            ...
            <section className="py-12 px-6 bg-gray-50 border-y border-gray-200">
                <div className="max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-8 text-sm">
                    <Link href="/consultoria/automatizacion-seo-ia" className="inline-flex items-center gap-2 text-[#E11D48] hover:text-black font-mono uppercase tracking-wide transition-colors">
                        <span className="material-symbols-outlined text-lg">terminal</span>
                        Automatización con IA
                    </Link>
                    <span className="hidden sm:block text-gray-300">|</span>
                    <Link href="/consultoria/arquitectura-seo-geo" className="inline-flex items-center gap-2 text-gray-500 hover:text-black font-mono uppercase tracking-wide transition-colors">
                        <span className="material-symbols-outlined text-lg">network_node</span>
                        Arquitectura & GEO
                    </Link>
                </div>
            </section>
