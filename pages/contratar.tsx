...
export default function Contratar() {
    return (
        <>
            <SeoHead noindex title="Contrata a Calvo: Limited Availability | Calvo Creativo" description="Disponibilidad limitada para proyectos de SEO estratégico, GEO y automatización. Sin contratos largos ni agencias intermediarias. Directo al consultor." />
            <Navigation />
